import { getModelForClass, index, plugin, prop, Ref } from "@typegoose/typegoose"
...
export const SubDomainModel = getModelForClass(SubDomain, { schemaOptions: { timestamps: true } })
