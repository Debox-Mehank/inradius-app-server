...
import { RegisterContent, RegisterContentInput, RegisterContentType, UpdateRegisterContentInput } from "../schema/masters/register.content.schema";
...
export default class RegisterContentResolver {
    constructor(private service: RegisterContentService) {
      ...
      allRegisterContent(
        @Arg("type", () => RegisterContentType, { nullable: true }) type: RegisterContentType,
    @Ctx() context: Context
        ) {
