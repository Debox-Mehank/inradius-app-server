...
import { CreateEmployeeInput, Employee, UpdateEmployeeInput } from "../schema/employee.schema";
...
export default class EmployeeResolver {
    ...
    @Mutation(() => Employee)
    @UseMiddleware([isAuth])
    updateEmployee(@Arg('input') input: UpdateEmployeeInput, @Ctx() context: Context) {
